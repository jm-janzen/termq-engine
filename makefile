...
bin/main: bin/main.o bin/menu.o bin/game.o bin/InfoPanel.o bin/Actor.o bin/Player.o bin/Enemy.o
	g++ -g bin/main.o bin/menu.o bin/game.o bin/InfoPanel.o  bin/Actor.o bin/Player.o bin/Enemy.o -o bin/main $(CFLAGS) -lncurses
...
bin/game.o: src/game.cpp src/game.h src/menu.h src/InfoPanel.h src/Actor.h src/Player.h src/Enemy.h
...
bin/Enemy.o: src/Enemy.cpp src/Enemy.h bin/Actor.o
	g++ -g -c -o bin/Enemy.o src/Enemy.cpp $(CFLAGS)
