...
bin/main: bin/main.o bin/menu.o bin/game.o bin/InfoPanel.o
	g++ -g -o bin/main bin/main.o bin/menu.o bin/game.o bin/InfoPanel.o $(CFLAGS) -lncurses
...
bin/game.o: src/game.cpp src/game.h src/menu.h src/InfoPanel.h
